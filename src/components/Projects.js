						...
						>
							<div className="flex relative">
								<img
									...
									alt="gallery"
								/>
								<div className="px-8 z-10 py-10 relative w-full h-full   overflow-auto border-4 border-gray-100 bg-gray-900 opacity-0 hover:opacity-100">
									...
									<a
										className="  bg-blue-500 hover:bg-blue-700 text-white  font-bold mt-4 py-2 px-4 rounded whitespace-nowrap  "
